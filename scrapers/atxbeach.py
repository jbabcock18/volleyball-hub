...
SOURCE = "ATX Beach"
URL = "https://atxbeach.volleyballlife.com/events"
LOCATION = "Austin, TX"
...
def _clean_title(raw: str) -> str:
    ...
    title = re.sub(r"\s*[-|•]\s*ATX Beach.*$", "", title, flags=re.IGNORECASE)
    title = title.strip(" *|-:\t")
...
def scrape() -> list[Tournament]:
    try:
        ...
        raise ScrapeDependencyError(
            "Playwright is required for ATX Beach scraping. Install dependencies and run 'playwright install chromium'."
        ) from exc
